...
# Exemplo de insight:
# 58% dos funcionários têm menos de 3 anos de experiência de trabalho antes de entrar na Empresa
...
# Investigando a relação do equilíbrio entre vida pessoal e profissional e renda mensal
ggplot(data = subset(dados_rh, !is.na(WorkLifeBalance)), aes(WorkLifeBalance, MonthlyIncome)) + 
  geom_boxplot()

# Exemplo de insight
# Os funcionários que avaliaram o equilíbrio entre vida profissional e pessoal igual a 1 também têm 
#renda média mensal significativamente mais baixa.
...
# Esse trabalho foi concentrado em tentar ajudar o RH a recrutar melhor visando evitar atritos 
